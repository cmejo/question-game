...
import { Users, Calendar, MessageCircle, Search, ChevronDown, ChevronRight, SortAsc, SortDesc } from 'lucide-react';
...
export const PeopleAnswers: React.FC<PeopleAnswersProps> = ({
  ...
  const [sortBy, setSortBy] = useState<'name' | 'answers' | 'date'>('date');
  ...
  const sortedPeople = [...filteredPeople].sort((a, b) => {
    ...
    switch (sortBy) {
      case 'name':
        ...
        break;
      case 'answers':
        comparison = a.totalAnswers - b.totalAnswers;
        break;
      case 'date':
      default:
        comparison = new Date(a.lastAnswered).getTime() - new Date(b.lastAnswered).getTime();
        break;
    }
  ...
  const toggleSort = (newSortBy: 'name' | 'answers' | 'date') => {
    if (sortBy === newSortBy) {
